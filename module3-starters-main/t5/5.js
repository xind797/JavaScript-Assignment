...
picArray.forEach((pic) => {
  ...
  // Create and add <h2> for the title
  const titleElement = document.createElement("h2");
  titleElement.textContent = pic.title;
  articleElement.appendChild(titleElement);

  // Create <figure> element
  const figureElement = document.createElement("figure");

  // Add <img> element inside <figure>
  const imgElement = document.createElement("img");
  imgElement.src = pic.image.medium; // Use medium-sized image
  imgElement.alt = pic.title; // Use title as alt text
  figureElement.appendChild(imgElement);

  // Add <figcaption> for the image caption
  ...
  // Create and add <p> for the description
